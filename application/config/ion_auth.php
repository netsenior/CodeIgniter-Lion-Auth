...
*/
$config['tables']['users']           = 'lion_auth_users';
$config['tables']['groups']          = 'lion_auth_groups';
$config['tables']['users_groups']    = 'lion_auth_users_groups';
$config['tables']['login_attempts']  = 'lion_auth_login_attempts';
